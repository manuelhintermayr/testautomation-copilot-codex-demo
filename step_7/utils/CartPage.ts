...
export class CartPage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    // Correct empty cart message based on actual DOM
    this.emptyCartMessage = page.getByText('Your cart is waiting for some amazing tech!');
    this.continueShoppingButton = page.getByRole('button', { name: 'Start Shopping' });
    ...
    // More flexible quantity selector - look for text between + and - buttons
    this.quantityDisplays = page.locator('[class*="quantity"]').or(
  ...
  async navigateToCart() {
    // Use specific selector for the cart button in navigation
    await this.page.locator('nav button:has-text("Cart")').click();
  }
