    ...
    createApp({
        ...
        computed: {
            ...
            allItemsSupportDroneDelivery() {
                ...
                return this.cart.every(item => item.product.droneDeliverySupported === true);
            }
        },
        mounted() {
            this.applyTheme();
        ...
        methods: {
            ...
            placeOrder() {
                ...
                if ((this.deliveryMethod === 'delivery' || this.deliveryMethod === 'drone') && !this.customerInfo.address) {
                ...
                if (this.deliveryMethod === 'drone' && !this.allItemsSupportDroneDelivery) {
                    const unsupportedItems = this.cart
                        ...
                        .join(', ');
                    alert(`Drone delivery is not available for the following items: ${unsupportedItems}. Please choose a different delivery method.`);
                    return;
                }
